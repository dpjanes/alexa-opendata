...
const load_configuration = (_self, done) => {
    assert.ok(self.data, "load_configuration: self.folder required");
...
const load_data_from_file = (_self, done) => {
    ...
    assert.ok(self.data, "load_data_from_file: self.folder required");
...
const parse_xml = (_self, done) => {
    ...
    assert.ok(self.data, "parse_xml: self.body required");
...
const parse_json = (_self, done) => {
    ...
    assert.ok(self.data, "parse_json: self.body required");
