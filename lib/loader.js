...
const main = (compile) => {
    compile((error, outds) => {
        ...
        console.log(yaml.safeDump(outds, { sortKeys: true, skipInvalid: true }))
    });
}
 ...
 *  API
 */
exports.load_configuration = Q.denodeify(_load_configuration);
exports.load_data_from_file = Q.denodeify(_load_data_from_file);
exports.load_data_from_url = Q.denodeify(_load_data_from_url);
exports.parse_xml = Q.denodeify(_parse_xml);
exports.parse_json = Q.denodeify(_parse_json);
exports.flatten_xml = Q.denodeify(_flatten_xml);
