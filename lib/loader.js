 ...
 *  Sometimes body is already parsed. In 
 *  this case we just move it into data
 */
...
const main = (compile) => {
    compile({
        ...
        console.log(yaml.dump(self.itemds, { sortKeys: true, skipInvalid: true }))
    });
}
