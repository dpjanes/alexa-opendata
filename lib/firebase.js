...
const _authenticate = (_self, done) => {
    const self = _.d.clone.shallow(_self);

    assert.ok(self.firebase, "firebase.authenticate: self.firebase required");
    assert.ok(self.firebase_admin, "firebase.authenticate: self.firebase_admin required");
...
exports.firebase.authenticate = Q.denodeify(_authenticate);
